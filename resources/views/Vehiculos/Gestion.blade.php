<x-app-layout>
    ...
    <div class="mt-5 container">
                ...
                <tbody>
                    ...
                    @foreach ($camiones as $camion)
                        <tr>
                            ...
                            <td class="hidden" id="miConductores" data-conductor="{{ json_encode($conductores) }}"></td>
        ...
        <div id="edit" class="editarContenedor hidden">
            <div class="borderedit ">
                ...
                <form class="mt-3" method="POST" action="{{ route('Vehiculos.Actualizar', $camion) }}"
        ...
        <div id="asignar" class="hidden">
            ...
            <form method="POST" action="{{route('Vehiculos.Asignar',$camion)}}" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div id="infoAsignar" class="hidden">
        ...
        <div id="cambiar" class="hidden">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div id="infoestado" class="hidden">
    ...
    <script src="{{ asset('js/editarVehiculo.js') }}?v2"></script>
    <script src="{{ asset('js/AsignarVehiculo.js') }}?v2"></script>
