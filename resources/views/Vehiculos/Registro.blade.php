        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form  class="mt-3" method="POST"  action="{{ route('Vehiculos.store') }}" enctype="multipart/form-data">
                            @csrf
        
                            <div class="row mb-3">

                                <label for="matricula" class="col-md-3 col-form-label text-md-start">{{ __('Matricula') }}</label>
                                 <div class="col-md-8">
                            ...
                            <div class="row mb-3">
                                <label for="Marca" class="col-md-3 col-form-label text-md-start">{{ __('Marca') }}</label>
                                <div class="col-md-8">
                            ...
                            <div class="row mb-3">
                                <label for="modelo" class="col-md-3 col-form-label text-md-start">{{ __('Modelo') }}</label>
                                <div class="col-md-8">
                            ...
                            <div class="row mb-3">
                                <label for="color" class="col-md-3 col-form-label text-md-start">{{ __('Color') }}</label>
                                <div class="col-md-8">
                            ...
                            <div class="row mb-3">
                                <label for="tipo" class="col-md-3 col-form-label text-md-start">{{ __('Tipo') }}</label>
                            ...
                            <div class="row mb-3">
                                <label for="foto" class="col-md-3 col-form-label text-md-start">{{ __('Foto del Vehiculo') }}</label>
