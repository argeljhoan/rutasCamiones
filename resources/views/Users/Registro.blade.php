                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="mt-3" method="POST" action="{{ route('Users.store') }}"
                                ...
                                <div class="row mb-3">
                                    <label for="rol"
                                        class="col-md-3 col-form-label text-md-start">{{ __('Rol') }}</label>
                                ...
                                <div class="row mb-3">
                                    <label for="foto"
                                        class="col-md-3 col-form-label text-md-start">{{ __('Foto de Perfil') }}</label>
