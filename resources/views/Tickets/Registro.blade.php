                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input id="destino" type="text"
                                        ...
                                        name="destino" value="{{ old('destino') }}" required
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input id="pesoTara" type="text"
                                        class="form-control @error('pesoTara') is-invalid @enderror" name="pesoTara"
                                        value="{{ old('pesoTara') }}" required autocomplete="pesoTara" autofocus>
                                    @error('pesoTara')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                               ...
                               <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input id="pesoBruto" type="text"
                                        class="form-control @error('pesoBruto') is-invalid @enderror" name="pesoBruto"
                                        value="{{ old('pesoBruto') }}" required autocomplete="pesoBruto" autofocus>
                                    @error('pesoBruto')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input id="pesoNeto" type="text"
                                        class="form-control @error('pesoNeto') is-invalid @enderror" name="pesoNeto"
                                        value="{{ old('pesoNeto') }}" required autocomplete="pesoNeto" autofocus>
                                    @error('pesoNeto')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input id="recibido" type="text"
                                        class="form-control @error('recibido') is-invalid @enderror" name="recibido"
                                        value="{{ old('recibido') }}" required autocomplete="recibido" autofocus>
                                    @error('recibido')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
